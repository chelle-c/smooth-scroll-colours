...
>
	...
	>
		<div class="font-sans font-semibold text-xl underline pointer-events-auto hover:font-bold">
			<a
				href="https://www.frontendpractice.com/projects/backstage-talks">Project Idea</a
			>
		</div>
		<div class="font-sans font-semibold text-xl pointer-events-auto">
			<ul class="min-w-max">
				<li><a href="#section5" class="hover:font-bold">Image #5</a></li>
				<li><a href="#section4" class="hover:font-bold">Image #4</a></li>
				<li><a href="#section3" class="hover:font-bold">Image #3</a></li>
				<li><a href="#section2" class="hover:font-bold">Image #2</a></li>
				<li><a href="#section1" class="hover:font-bold">Image #1</a></li>
			</ul>
		</div>
	</div>
</main>
