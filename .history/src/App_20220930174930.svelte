<script>
	...
	let setColour = () => {
		...
		for (let index = 0; index < sections.length; index++) {
			if (yTop <= innerHeight * index <= yBottom) {
...
<div
	id="background"
	class="min-w-full min-h-screen z-0 absolute"
...
>
	...
	>
		...
		<div class="font-sans font-bold text-xl">
			Y Position: {yTop}, Total Height: {yHeight}, innerHeight: {innerHeight}
		</div>
	</div>
