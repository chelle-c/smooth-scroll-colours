...
>
	...
	>
		...
		<div class="font-sans font-bold text-xl">Y Position: {yTop}, Total Height: {yHeight}, innerHeight: {innerHeight}</div>
	</div>
	...
	{#each [...sections].reverse() as { id, image, alt, colour }}
		...
		>
			<div id="background" class="min-w-full min-h-screen z-0 absolute" style="background: blueviolet" />
