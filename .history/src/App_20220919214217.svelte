...
<div class="scrollsnap-container" bind:this={box}>
	<main
		class="min-w-full min-h-screen fixed flex flex-col justify-between p-6"
	>
		<div class="flex flex-row justify-between items-baseline z-10">
			<div>
		...
		<div class="flex flex-row justify-between items-end z-10">
